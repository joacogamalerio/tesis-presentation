...
\begin{itemize}
  ...
  \item Esa salida puede interpretarse como una decisión simple.
\end{itemize}

\column{0.64\textwidth}
\centering
\thesisimage[width=\linewidth,height=6.8cm,keepaspectratio]{01_perceptron_simple.jpg}{5.8cm}
\end{columns}
...
% ------------------------------------------------------------
\begin{frame}{Redes \textit{feed-forward}}
\begin{columns}[T,totalwidth=\textwidth]
\column{0.32\textwidth}
\begin{itemize}
  ...
  \item Las capas intermedias construyen representaciones cada vez más útiles.
  \item La predicción final se obtiene a partir de la última capa.
\end{itemize}

\column{0.64\textwidth}
\centering
\thesisimage[width=\linewidth,height=6.25cm,keepaspectratio]{02_perceptron_multicapa.jpg}{5.4cm}
\vspace{0.05cm}
\end{columns}
\end{frame}
