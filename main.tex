...
% ------------------------------------------------------------
\begin{frame}{Diapositiva Opcional}
\begin{table}
\centering
\small
...
\begin{itemize}
  \item \textbf{MMV:} mejor modelo según pérdida de validación.
  \item \textbf{MMV:} selecciona el modelo que alcanza la menor pérdida de validación durante todo el entrenamiento.
  \item \textbf{\textit{Early stopping}:} modelo elegido por una política de detención temprana.
  \item \textbf{\textit{Early stopping}:} usa pérdida de validación como métrica y una tolerancia definida.
\end{itemize}
\note{
