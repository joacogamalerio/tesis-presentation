...
\newcommand{\thesisimage}[3][]{%
  \IfFileExists{#2}{\includegraphics[#1]{#2}}{%
    \makebox[\linewidth][c]{\fbox{\begin{minipage}[c][#3][c]{0.92\linewidth}
...
\begin{tabular}{cc}
\textbf{Esparsidad autoencoder base} & \textbf{Esparsidad Dropout} \\
\thesisimage[width=0.49\textwidth,height=0.78\textheight,keepaspectratio]{imagenes_resultados/autoencoder/OverFitNet/first_layer_parameter_sparsity.png}{6.0cm} &
\thesisimage[width=0.49\textwidth,height=0.78\textheight,keepaspectratio]{imagenes_resultados/autoencoder/Dropout/first_layer_parameter_sparsity.png}{6.0cm}
\end{tabular}
\smallsource{imagenes_resultados/autoencoder/OverFitNet/first_layer_parameter_sparsity.png; imagenes_resultados/autoencoder/Dropout/first_layer_parameter_sparsity.png}
\end{frame}
...
\begin{tabular}{cc}
\textbf{Esparsidad DropConnect} & \textbf{Esparsidad BoostDropout} \\
\thesisimage[width=0.49\textwidth,height=0.78\textheight,keepaspectratio]{imagenes_resultados/autoencoder/DropConnect/first_layer_parameter_sparsity.png}{6.0cm} &
\thesisimage[width=0.49\textwidth,height=0.78\textheight,keepaspectratio]{imagenes_resultados/autoencoder/BoostDropout/first_layer_parameter_sparsity.png}{6.0cm}
\end{tabular}
\smallsource{imagenes_resultados/autoencoder/DropConnect/first_layer_parameter_sparsity.png; imagenes_resultados/autoencoder/BoostDropout/first_layer_parameter_sparsity.png}
\end{frame}
